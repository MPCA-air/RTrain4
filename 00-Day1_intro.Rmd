...
class <- c("Derek", "Kristie", "Laurie", "Sophie", 
           "Shannon", "Joseph", "Jesse", "Dan", "Lad", "Andrew", 
           "Angus", "Jeffrey", "Jenny", "Kevin", "Barbara", "Dorian", "Casey", "Ashley", "Rey", "R","2019", "BB8", "Porgs!", "Jakku")

frequency <- c(as.numeric(sample(7:11, length(class)-5, replace = T)), 24,25,16,26,14)

# Add 10 random Star Wars names as small text, size = 4
frequency <- c(frequency, rep(4, 13))

class <- c(class, sample_n(starwars, 13)$name)  


wordcloud2(data.frame(word = class, freq = frequency), size = .6, color = 'random-dark')
