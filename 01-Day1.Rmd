...
![](images/class_cloud.png){style="width: 87%; margin-left: 6%; margin-bottom: 20px; margin-top: -37px;"}

Let's introduce ourselves and the data we love. Chat with your breakout __partner__ and get to know 3 things about them.

<br>

__Things to share__  

![](images/starwars_group.jpg){align="right" style="width: 50%; margin-left: 26px; margin-top: 8px;"}
...
<div class="well">
__TEAMWORK:__ You're going to need to work together to help Rey get off the dusty planet Jakku. Use each other as a resource. Share ideas, share code, collaborate. Make bad jokes.
</div>

**Here's one:**

<details>
<summary class = "btn_code">   __What Jedi is best at opening PDF files?__
 </summary>
...
We are __Barbara__, __Dorian__,  __Kristie__ and __Derek__. Yes, we look exactly like our profile photos above.   

We aren't computer scientists and that's okay! 

We make lots of mistakes. Mistakes are funny. Feel free to laugh at them. 
...
<h2 style="font-size: 44px; margin-top: 12px;"> <i class="fa fa-rocket" aria-hidden="true"></i> _Blast off!_ </h2>
...
<div class="well">
Now that we're ready, let's go forth and make some trouble. While BB8 works on tracking down some data for us from his droid friends, we'll get to know his internal computer. 
</div>
...
Go to [Help!](help.html) for some troubleshooting options, cheatsheets, and other learning resources. 
