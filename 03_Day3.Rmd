...
- Review
- Endor storm chasing: <i class="fa fa-calendar" aria-hidden="true"></i> __dates__
- The magic pipe `%>%`
- Where's Finn?
- Join 2 tables: `left_join` to the rescue
- Calculate summary stats for __entire table__
- `group_by`: Calculate stats for each group or category
- __Save__ / export data
...
<span class="btn_code_blue" style="margin-bottom: 10px;"> __DOWNLOAD__  </span></a> -  Get the Endor Air data
